    ...
    <footer className="footer">
      <div className="container text-white" data-aos="fade-up">
        <div className="row gx-5 gx-lg-4 gx-xl-5 gy-5">
          <div
            className="col-md-6 col-lg-4 footer__left text-center text-lg-start"
            data-aos="fade-up"
            data-aos-delay="100"
            data-aos-offset="0"
          >
          ...
          <div
            className="col-md-6 col-lg-4 footer__middle text-center text-lg-start"
            data-aos="fade-up"
            data-aos-delay="200"
            data-aos-offset="0"
          >
          ...
          <div
            className="col-12 col-lg-4 footer__right text-center text-lg-start"
            data-aos="fade-up"
            data-aos-delay="300"
            data-aos-offset="0"
          >
